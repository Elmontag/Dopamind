...
function TaskItem({ task, t, onTagClick, onCategoryClick, categories, countdownStartEnabled, sizeMappings, allTags, touchDragProps }) {
  ...
  if (editing) {
    return (
      <div className="fixed inset-0 z-50 flex items-start justify-center pt-[5vh] pb-16 lg:pb-0 bg-black/60" onClick={(e) => { if (e.target === e.currentTarget) setEditing(false); }}>
